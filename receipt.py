""" WollPay Receipt (Version 04.02 of receipt.py program). """
...
def receipt():
    ...
    while i != 'q':
        ...
        print('\nHello Host! \
\nYou run version 04.02 of the program receipt.py.')
