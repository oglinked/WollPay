""" WollPay Clients Base (Version 01.03 of the clientsbase.py). """
...
def clientsbase():
    ...
    time_zone = 'GMT+2'  # Time zone "Poland".
...
clientsbase.py program.')
        ...
        source = iv.choose_item('Source', source_list)
        ...
        dependent = iv.empty_field(dependent)
